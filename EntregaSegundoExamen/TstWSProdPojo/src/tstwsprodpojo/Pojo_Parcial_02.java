...
/*fin comentario 4.3) */
       ...
       //      
        ...
        System.out.println("Los encabezados y sus items son:" + ( lisitems.isEmpty() ? " Lista sin elementos":"" ));
        
        int n = 1;

        for(wscustord.CustomerOrder customerOrder : lisco){
            System.out.println("Encabezado " + n + "\n" + "Customer ID: " + customerOrder.getId() + " Cantidad: " + customerOrder.getAmount() + " Fecha de creación: " + customerOrder.getAmount() + " Número de confirmación: " + customerOrder.getAmount() + "\n" + "Items del encabezado:");

            for(wsordprod.OrderedProduct orderedProduct : lisitems)
            {
                if(orderedProduct.getOrderedProductPK().getCustomerOrderId() == customerOrder.getId()){
                    System.out.println("ID del producto: " + orderedProduct.getProduct().getId() + " Nombre del producto: "+ orderedProduct.getProduct().getName() + " Cantidad del producto: " + orderedProduct.getQuantity());
                }
            }
           n++;
       }
       ...
       for(wscustord.CustomerOrder co : lisco){
        ...
        System.out.println("El monto total de los pedidos es: " + cont);
