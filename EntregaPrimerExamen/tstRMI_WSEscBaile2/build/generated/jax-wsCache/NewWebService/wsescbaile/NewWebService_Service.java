 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://wsEscBaile/", wsdlLocation = "http://192.168.1.107:8080/EscBaileWeb/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://wsEscBaile/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.107:8080/EscBaileWeb/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://wsEscBaile/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsEscBaile/", "NewWebServicePort"), NewWebService.class, features);
    }
