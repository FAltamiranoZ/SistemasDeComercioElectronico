...
// ---------------------------------------------------------------------------
    ...
    public boolean altaAlumno(String arr_nomCampos[], String arr_datos[]) {
        ...
        //para el valor antiguo. En el caso de alta, el valor antiguo va vacío y
        //viceversa en el caso de baja, solo en modificados se llenan los 2
        ...
        //El hecho de que cada hoja tenga su nombre (como clvAlumno) es para
        //que podamos llamar a cualquier atributo del campo usando:
        //nombreArbol.clvAlumno.valor.
        
//El colCampos con el que vamos a trabajar es traido del método mapaCampos, el
//cual usa un resultSet (rs) que es un select * from nomTabla. Lo que hace
//mapaCampos es que utiliza el primer resultado del rs, el cual solo son 
//las columnas, para generar un arbol que obtenga la info de estas.
//Podríamos en lugar de usar el colCampos, crear nuestro propio arbol como en 
//el main de ClsConexion, este arbol simplemente nos facilita el nombre de 
//las columnas y su tipo.
//Es importante entender que rellenar este campo no afecta en lo más mínimo a la
//base de datos, este arbol posteriormente será leido por InsertaReg y se 
//generará el query correspondiente para afectar; es decir, solo es una manera
//de organizar la info que se le ocurrió a Gamboa.
    ...
    //Yo cree esta función que elimina alumnos al recibir todos los datos de 
    //valor y valwhere
