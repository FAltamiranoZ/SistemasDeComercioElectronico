...
// ---------------------------------------------------------------------------    
    ...
    public boolean conectate(String unUID, String unPwd) {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:derby://localhost:1527/" + this.strNomDB, "app", "app");
    ...
    public boolean insertaReg(String strTV, java.util.TreeMap<String, ClsCampoBD> colCampos) {
        ...
        while (it.hasNext()) {
            ...
            if (campo.valor.length() > 0) {
                ...
                //Codifica dato solamente altera el valor si es varchar o date para
...
// ---------------------------------------------------------------------------    
    ...
    public static void main(String[] args) {
        ...
        //Aquí se probaron los métodos 8 y 9 y funcionan correctamente
        int intPrueba[] = {1, 5, 4, 6, 2, 7, 2};
        int i, n = 7;
        ResultSet r = null;
        java.util.TreeMap<String, ClsCampoBD> colCampos = null;

        String strLocBD = "ejemplo";

        try {
            ClsConexion c = new ClsConexion(strLocBD);
            c.conectate("rafa", "rafa"); //Esto es username y password
            if (c.conectado()) {
                for (i = 0; i < n; i++) {
                    switch (intPrueba[i]) {
                        case 1:  //Imprime la tabla 
                            ...
                            break;
                        case 2://Dice el último comando que se ejecutó e imprime 
                            //la tabla
                            r = c.obtenRS("tblAlumnos");
                        ...
                        case 3:
                            ...
                            System.out.println(c.impRS(r));
                            break;
                        case 4: //Dice el último comando que se ejecutó e imprime 
                            //solamente clvAlumno y apPaterno
                            ...
                            System.out.println(c.impRS(r));
                            break;
                        case 5: //Inserta un nuevo alumno
                            colCampos = new TreeMap<String, ClsCampoBD>();
                            ...
                            //System.out.println(c.impRS(r));
                            break;
                        case 6: //Modifica los datos de algun alumno
                            colCampos = new TreeMap<String, ClsCampoBD>();
                            colCampos.put("apPaterno",
                        ...
                        case 7: //Elimina a un alumno
                            ...
                            //System.out.println(c.impRS(r));
                            break;
//El caso 8 es en el que se prueba la inserción de registros siguiendo un 
//prefijo y número secuencial
                        case 8:
                            colCampos = new TreeMap<String, ClsCampoBD>();
                            colCampos.put("apPaterno",
                                    new ClsCampoBD("apPaterno", "apPrueba", ClsCampoBD.TIPO_VARCHAR, ""));
                            colCampos.put("apMaterno",
                                    new ClsCampoBD("apMaterno", "apPrueba", ClsCampoBD.TIPO_VARCHAR, ""));
                            colCampos.put("nombre",
                                    new ClsCampoBD("nombre", "nombrePrueba ", ClsCampoBD.TIPO_VARCHAR, ""));
                            colCampos.put("clvAlumno", new ClsCampoBD("clvAlumno", "1000" + i, ClsCampoBD.TIPO_VARCHAR, ""));
                            c.insertaReg("tblAlumnos", colCampos);
                            //System.out.println(c.impRS(r));
                            break;
//El caso 9 es en el que se prueba la eliminación de registros siguiendo un 
//prefijo y número secuencial
                        case 9:
                            colCampos = new TreeMap<String, ClsCampoBD>();
                            colCampos.put("apPaterno",
                                    new ClsCampoBD("apPaterno", "", ClsCampoBD.TIPO_VARCHAR, "apPrueba"));
                            colCampos.put("apMaterno",
                                    new ClsCampoBD("apMaterno", "", ClsCampoBD.TIPO_VARCHAR, "apPrueba"));
                            colCampos.put("nombre",
                                    new ClsCampoBD("nombre", "", ClsCampoBD.TIPO_VARCHAR, "nombrePrueba"));
                            colCampos.put("clvAlumno", new ClsCampoBD("clvAlumno", "", ClsCampoBD.TIPO_VARCHAR, "2525"));
                            c.eliminaRegs("tblAlumnos", colCampos);
                            //System.out.println(c.impRS(r));
                            break;
